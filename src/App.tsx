...
import AdminTheoryPage from '@/pages/admin/AdminTheoryPage';
import TheoryPage from '@/pages/user/TheoryPage';
...
function AuthInit() {
  ...
  const handleAuthStateChange = useCallback((_event: any, session: any) => {
    setSession(session);
    if (session?.user) {
  ...
  }, [setSession, fetchProfile, setLoading, handleAuthStateChange]);
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route element={<UserLayout />}>
            ...
            <Route path="/theory/:subjectId" element={<TheoryPage />} />
