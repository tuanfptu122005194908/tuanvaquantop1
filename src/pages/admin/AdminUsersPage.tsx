...
import { Search, ShieldCheck, ShieldOff, BookOpen, User, Mail, Calendar, Phone, Download, Trash2 } from 'lucide-react';
                    ...
                    <div className="flex gap-1 justify-center">
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button size="sm" variant="ghost" className="gap-1 text-xs h-7 text-destructive hover:text-destructive hover:bg-destructive/10" disabled={u.id === profile?.id}>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Bạn có chắc muốn xóa tài khoản <strong>{u.username}</strong> ({u.email})? Hành động này không thể hoàn tác.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
