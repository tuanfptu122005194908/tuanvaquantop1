...
import { LayoutDashboard, BookOpen, Settings, GraduationCap, Menu, X, LogOut, ShoppingCart, CreditCard, Mail, Phone, MapPin, Github, Twitter, Instagram, Globe, Facebook, Youtube, MessageCircle, HelpCircle, Star, Search, BookOpenCheck } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/theory', label: 'Lý thuyết', icon: BookOpenCheck },
...
export default function UserLayout() {
  ...
  useEffect(() => {
    if (searchQuery.trim()) {
      const delaySearch = setTimeout(() => searchSubjects(searchQuery), 300);
